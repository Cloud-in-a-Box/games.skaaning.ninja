...
# ../terraform import module.games.aws_cloudfront_origin_access_identity.default[0] EIMIIXLMVEYV || true
...
# ../terraform import module.games.aws_cloudfront_distribution.default E2PAE9UZIO3W9O || true
